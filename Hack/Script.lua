...
"❌     قناة....     ❌"},nil,"قائمة التهكير")
 if MN == nil then
  else
  if MN == 1 then WHC() end
  if MN == 2 then SMN() end
  if MN == 3 then VIP() end
  if MN == 4 then WPH() end
  if MN == 5 then SKIN() end
  if MN == 6 then RRB() end
  if MN == 7 then
     CLOSE()
     end
  end
...
"🔙Back",
  ...
  if MN8[1] == true then VGF() end
  if MN8[2] == true then CARSFLY() end
  if MN8[3] == true then flashVIP() end
  if MN8[4] == true then speedVIP() end
  if MN8[5] == true then VSP() end
  if MN8[6] == true then FKC() end
  if MN8[7] == true then ATP() end
  if MN8[8] == true then ATNFIX() end
  if MN8[9] == true then ATN700() end
  if MN8[10] == true then ATR() end
  if MN8[11] == true then ATB() end
  if MN8[12] == true then FGA() end
  if MN8[13] == true then NGE() end
  if MN8[14] == true then NGS() end
  if MN8[15] == true then NGT() end
  if MN8[16] == true then NGTH() end
  if MN8[17] == true then NFS() end
  if MN8[18] == true then DJP() end
  if MN8[19] == true then HJP() end
  if MN8[20] == true then NLJ() end
  if MN8[21] == true then MJP() end
  if MN8[22] == true then FPH() end
  if MN8[23] == true then JSP() end
  if MN8[24] == true then JCL() end
  if MN8[25] == true then BPL() end
  if MN8[26] == true then SPL() end
  if MN8[27] == true then NLHF() end
  if MN8[28] == true then CVL() end
  if MN8[29] == true then CVM() end
  if MN8[30] == true then CVH() end
  if MN8[31] == true then HOME() end
  end
  PUBGMH = -1
end
...
function MJP()
  ...
  gg.toast("Multy Jump Activated!")
  gg.clearResults()
end

function VGF()
gg.alert("You Can Change The Speed :)")
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
...
gg.editAll("67.5;225", 16)
gg.clearResults()
gg.toast("Long Hand Foward activated!")
end
...
function FPH()
  ...
  gg.clearResults()
  gg.toast("Parachute Fast activated!")
end
...
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("-0.70710676908F;0.70710670948F;64.0F;128D;1D::512", 127, false, 536870912, 0, -1)
...
function NFS()
  ...
  gg.clearResults()
  gg.toast("No Foot Step activated!")
end
...
gg.editAll("0.07", 16)
gg.clearResults()
gg.toast("NoGrass + Trees + House activated!")
end
...
gg.getResults(100)
gg.editAll("16000", 16)
gg.toast("Antena 700M activated!")
end
...
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber("1;120;0.5;50;100;60,000.0;15;560", 16, false, 536870912, 0, -1)
gg.searchNumber("1", 16, false, 536870912, 0, -1)
gg.getResults(100)
gg.editAll("4.00", 16)
gg.clearResults()
...
"🔑 Open Anti-sealing [AFTER LANDING]",
"🔓 Final Anti-sealing [ENDMATCH]",
...
"Back 🔙",
  ...
  if MN8[1] == true then RRB10P() end
  if MN8[2] == true then RRB35() end
...
gg.clearResults()
gg.alert("Deactivated after chicken!")
end
...
"🔹Fix Wallhack Blink (Island)",
"🔹Fix Wallhack Scope Doesn't Shows (Pick Weapon)",
"🔹Wallhack SD400",
"🔹Wallhack SD410/615",
"🔹Wallhack SD425",
"🔹Wallhack SD430",
...
"🔹Wallhack Vivo",
"🔹Wallhack Oppo",
"🔹Wallhack All Mediatek",
"🔹Wallhack Mediatek X20",
"🔹Wallhack Mediatek X25",
"🔹Wallhack Mediatek P60",
"🔹Item Wallhack",
"🔹Perfect Wallhack All Snap",
"🔸Color White Mediatek",
"🔸Color White (All Device)",
"🔸Color Black (All Device)",
"🔸Color Red HDR",
"🔸Color Purple HDR",
"🔸Color Red",
"🔸Color Shark",
...
}, nil, "🇮🇩 Wallhack & Colour Menu & Other Menu 🇮🇩")
  if MN1 == nil then
  else

  if MN1[1] == true then FBlink() end
  if MN1[2] == true then FScop() end
  if MN1[3] == true then WH400() end
  if MN1[4] == true then WH410() end
  if MN1[5] == true then WH425() end
  if MN1[6] == true then WH430() end
  if MN1[7] == true then WH435() end
  if MN1[8] == true then WH450() end
  if MN1[9] == true then WH625() end
  if MN1[10] == true then WH626() end
  if MN1[11] == true then WH636() end
  if MN1[12] == true then WH653() end
  if MN1[13] == true then WH660() end
  if MN1[14] == true then WH710() end
  if MN1[15] == true then WH800() end
  if MN1[16] == true then WH810() end
  if MN1[17] == true then WH820() end
  if MN1[18] == true then WH835() end
  if MN1[19] == true then WH845() end
  if MN1[20] == true then WHALL() end
  if MN1[21] == true then WHEX() end
  if MN1[22] == true then WHHWI() end
  if MN1[23] == true then WHKRN() end
  if MN1[24] == true then WHVV() end
  if MN1[25] == true then WHOP() end
  if MN1[26] == true then NWHM() end
  if MN1[27] == true then MTK2() end
  if MN1[28] == true then MTK() end
  if MN1[29] == true then MTK3() end
  if MN1[30] == true then PW5() end
  if MN1[31] == true then ITWH() end
  if MN1[32] == true then CLMF() end
  if MN1[33] == true then CMT1() end
  if MN1[34] == true then CMT2() end
  if MN1[35] == true then Red() end
  if MN1[36] == true then PurpleHdr() end
  if MN1[37] == true then Red2() end
  if MN1[38] == true then Shark() end
  if MN1[39] == true then Pluto() end
  if MN1[40] == true then Green() end
  if MN1[41] == true then Blue() end
  if MN1[42] == true then Yellow() end
  if MN1[43] == true then White1() end
  if MN1[44] == true then Orange1() end
  if MN1[45] == true then Rainbow() end
  if MN1[46] == true then Black3() end
  if MN1[47] == true then BlackExynos() end
  if MN1[48] == true then YLW615() end
  if MN1[49] == true then Red425() end
  if MN1[50] == true then Purple425() end
  if MN1[51] == true then Blue425() end
  if MN1[52] == true then Yellow425() end
  if MN1[53] == true then GRN615() end
  if MN1[54] == true then BLUE615() end
  if MN1[55] == true then Color68() end
  if MN1[56] == true then Green6025() end
  if MN1[57] == true then Color660Red() end
  if MN1[58] == true then Color660Yellow() end
  if MN1[59] == true then Color845Yellow() end
  if MN1[60] == true then Color845Red() end
  if MN1[61] == true then Color845Green() end
  if MN1[62] == true then CarColor() end
  if MN1[63] == true then BlackSky() end
  if MN1[64] == true then BlackSky425() end
  if MN1[65] == true then RSKY() end
  if MN1[66] == true then BloodColor() end
  if MN1[67] == true then DarkLand() end
  if MN1[68] == true then SnowLand() end
  if MN1[69] == true then
 HOME() 
end
  end
...
gg.clearResults()
gg.setRanges(131072)
gg.searchNumber("3.7615819e-37;1.6623364e-19;1.1202035e-19;2", 16, false, 536870912, 0, -1)
gg.searchNumber("2", 16, false, 536870912, 0, -1)
gg.getResults(10)
gg.editAll("120", 16)
gg.clearResults()
gg.setRanges(131072)
gg.searchNumber("7.4051337e-40;5.5684798e-40;2.379632e21", 16, false, 536870912, 0, -1)
gg.searchNumber("2.379632e21", 16, false, 536870912, 0, -1)
gg.getResults(10)
gg.editAll("200", 16)
...
gg.editAll("130", 16)
gg.clearResults()
gg.toast("Wallhack Snap 810 activated!")
end
...
gg.editAll("5", 4)
gg.clearResults()
gg.toast("Color Blue 615 activated!")
end
...
gg.editAll("8", 4)
gg.clearResults()
gg.toast("Color Green 615 activated!")
end
...
gg.editAll("999", 16)
gg.clearResults()
gg.toast("New Mediatek Wallhack activated!")
end
...
function YLW615()
  ...
  gg.clearResults()
  gg.toast("Color Yellow 615 activated!")
end
...
function PurpleHdr()
  ...
  gg.clearResults()
  gg.toast("Color Purple HDR activated!")
end
...
"🔥No Recoil 99% (Pick Gun)",
"🔥Less Recoil OneClick (Lobby)",
"🔥No Recoil OneClick (Lobby)",
...
"🔙 Back",
  ...
  if MN6[1] == true then LRC() end
  if MN6[2] == true then NR() end
  if MN6[3] == true then LRL() end
  if MN6[4] == true then NRLBY() end
  if MN6[5] == true then NRAW() end
  if MN6[6] == true then MAIM() end
  if MN6[7] == true then SAIM() end
  if MN6[8] == true then AHS() end
  if MN6[9] == true then MB() end
  if MN6[10] == true then DPS() end
  if MN6[11] == true then LCK() end
  if MN6[12] == true then QSH() end
  if MN6[13] == true then BTK() end
  if MN6[14] == true then SIS() end
  if MN6[15] == true then STS() end
  if MN6[16] == true then WST() end
  if MN6[17] == true then WLT() end
  if MN6[18] == true then HOME() end
  end
  PUBGMH = -1
end
...
function NRLBY()
  ...
  gg.editAll("0", gg.TYPE_DWORD)
  gg.clearResults()
  gg.toast("No Recoil OneClick Lobby activated!")
end
...
function SIS()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("-0.67914116382599;-0.20633073151112;-0.68966287374496;9.49029350281;0.0064272880554199::", gg.POINTER_WRITABLE, false, gg.SIGN_FUZZY_EQUAL, 0, -1)
  gg.searchNumber("9.49029350281", gg.POINTER_WRITABLE, false, gg.SIGN_FUZZY_EQUAL, 0, -1)
  gg.getResults(500)
  gg.editAll("333.0517578125", gg.POINTER_WRITABLE)
  gg.clearResults()
...
gg.editAll("999", 16)
gg.clearResults()
gg.toast("Semi AimLock activated!")
end
...
function DPS()
  ...
  gg.clearResults()
  gg.toast("High Damage Plus activated!")
end
...
"Back 🔙",
	  ...
	  }, nil, "🇮🇩 Weapon Hack Menu 🇮🇩")
  if MN8 == nil then
  else
  if MN8[1] == true then XEK() end
  if MN8[2] == true then QCW() end
  if MN8[3] == true then FSW() end
  if MN8[4] == true then SCR() end
  if MN8[5] == true then ABB() end
  if MN8[6] == true then AKAL() end
  if MN8[7] == true then SK12M() end
  if MN8[8] == true then Z4N() end
  if MN8[9] == true then Z4F() end
  if MN8[10] == true then ZH6() end
  if MN8[11] == true then Z8N() end
  if MN8[12] == true then Z8F() end
  if MN8[13] == true then Z15N() end
  if MN8[14] == true then Z15F() end
  if MN8[15] == true then HOME() end
  end
  PUBGMH = -1
end
...
function AKAL()
gg.clearResults()
gg.searchNumber("90.775703430176;0;8;15;16;18", 16, false, 536870912, 0, -1)
gg.searchNumber("18", 16, false, 536870912, 0, -1)
gg.getResults(100)
gg.editAll("955", 16)
gg.clearResults()
...
gg.clearResults()
gg.toast("AWM&K98 Aimlock activated!")
end
...
gg.clearResults()
gg.toast("Zoom Hack 6X activated!")
end
...
function ABB()
  ...
  gg.toast("AKM Brutal Bullet activated!")
end
...
function CLOSE()
  print("هذا السكربت ملك قناة .....")
  print("حسابي على الفيسبوك:......")
  print("قناتي على اليوتيوب:.....")
  print("قناتي هلى التيليجرام: .....")
  gg.skipRestoreState()
  os.exit()
  gg.setVisible(true)
end
